document.addEventListener('DOMContentLoaded', async function() {
    ...
    async function fetchDataWithCache(sheetName = 'Le_Atlass') { // Добавили параметр sheetName
    ...
    async function renderData(sheetName = 'Le_Atlass') { // Добавили параметр sheetName
    ...
    await renderData('Le_Atlass'); // Пример использования с листом по умолчанию
    ...
    inputFields.forEach((input) => {
        input.addEventListener('input', async function() {
            const column = input.getAttribute('data-column');
            const row = input.getAttribute('data-row');
            await saveData(input.value, column, row, 'Le_Atlass'); // Пример использования
        });
    });
});

// Функция для сохранения данных
async function saveData(value, column, row, sheetName = 'Le_Atlass') { // Добавили параметр sheetName
